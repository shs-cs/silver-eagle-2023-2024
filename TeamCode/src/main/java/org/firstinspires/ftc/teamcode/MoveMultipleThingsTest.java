...
//***************************** Put Auto Code Under Here To Run :o (please work) *******************
        ...
        */
        ...
        MovebotAndRaiseArmAndMoveSlide(0.6,-24, 1.0, -82, -0.8,-25);
        Pause(500);
        MoveWrist(WristSpecimenPosition);
        Pause(500);
        MoveTiles(0.6,-0.25);
        Pause(500);
        StrafeLeftTiles(0.6, 1.0);
...
//************************************ Autonomous Functions :) *************************************
    ...
    public void StrafebotAndRaiseArmAndMoveSlide(double StrafePower, double TileCount, double ArmPower, int ArmPosition, double ViperPower, int ViperPosition) {

        StrafeTiles(StrafePower, TileCount); // This moves the robot
